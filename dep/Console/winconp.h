...
DEFINE_PROPERTYKEY(PKEY_Console_ForceV2, 0x0C570607, 0x0396, 0x43DE, 0x9D, 0x61, 0xE3, 0x21, 0xD7, 0xDF, 0x50, 0x26, PID_CONSOLE_FORCEV2);
DEFINE_PROPERTYKEY(PKEY_Console_WrapText, 0x0C570607, 0x0396, 0x43DE, 0x9D, 0x61, 0xE3, 0x21, 0xD7, 0xDF, 0x50, 0x26, PID_CONSOLE_WRAPTEXT);
DEFINE_PROPERTYKEY(PKEY_Console_FilterOnPaste, 0x0C570607, 0x0396, 0x43DE, 0x9D, 0x61, 0xE3, 0x21, 0xD7, 0xDF, 0x50, 0x26, PID_CONSOLE_FILTERONPASTE);
DEFINE_PROPERTYKEY(PKEY_Console_CtrlKeyShortcutsDisabled, 0x0C570607, 0x0396, 0x43DE, 0x9D, 0x61, 0xE3, 0x21, 0xD7, 0xDF, 0x50, 0x26, PID_CONSOLE_CTRLKEYSDISABLED);
DEFINE_PROPERTYKEY(PKEY_Console_LineSelection, 0x0C570607, 0x0396, 0x43DE, 0x9D, 0x61, 0xE3, 0x21, 0xD7, 0xDF, 0x50, 0x26, PID_CONSOLE_LINESELECTION);
DEFINE_PROPERTYKEY(PKEY_Console_WindowTransparency, 0x0C570607, 0x0396, 0x43DE, 0x9D, 0x61, 0xE3, 0x21, 0xD7, 0xDF, 0x50, 0x26, PID_CONSOLE_WINDOWTRANSPARENCY);
DEFINE_PROPERTYKEY(PKEY_Console_WindowMaximized, 0x0C570607, 0x0396, 0x43DE, 0x9D, 0x61, 0xE3, 0x21, 0xD7, 0xDF, 0x50, 0x26, PID_CONSOLE_WINDOWMAXIMIZED);
...
DEFINE_PROPERTYKEY(PKEY_Console_InterceptCopyPaste, 0x0C570607, 0x0396, 0x43DE, 0x9D, 0x61, 0xE3, 0x21, 0xD7, 0xDF, 0x50, 0x26, PID_CONSOLE_INTERCEPT_COPY_PASTE);
#endif
