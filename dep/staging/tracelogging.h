...
private:
        ...
        public _TlgActivityBase<ActivityData<ActivityTraceLoggingType, TlgReflectorTag>, keyword, level>
    {
        ...
        auto CreateActivityIdByProviderType(int, _Out_ GUID& childActivityId) ->
            decltype(ProviderType::CreateActivityId(childActivityId, GetRelatedId()), (void)0)
        {
            ProviderType::CreateActivityId(childActivityId, GetRelatedId());
        }
...
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8, varName8, ...) \
    ...
    { __WI_TraceLoggingWriteTagged(*this, #EventId,  TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _TLG_STRINGIZE(varName1)), \
                                                ...
                                                TraceLoggingValue(static_cast<VarType6>(wistd::forward<T6>(varName6)), _TLG_STRINGIZE(varName6)), \
                                                TraceLoggingValue(static_cast<VarType7>(wistd::forward<T7>(varName7)), _TLG_STRINGIZE(varName7)), \
                                                TraceLoggingValue(static_cast<VarType8>(wistd::forward<T8>(varName8)), _TLG_STRINGIZE(varName8)), \
                                                TraceLoggingString(correlationVector, "__TlgCV__"), __VA_ARGS__); }
...
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM9(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8, varName8, VarType9, varName9, ...) \
    ...
    { __WI_TraceLoggingWriteTagged(*this, #EventId,  TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _TLG_STRINGIZE(varName1)), \
                                                ...
                                                TraceLoggingValue(static_cast<VarType7>(wistd::forward<T7>(varName7)), _TLG_STRINGIZE(varName7)), \
                                                TraceLoggingValue(static_cast<VarType8>(wistd::forward<T8>(varName8)), _TLG_STRINGIZE(varName8)), \
                                                TraceLoggingValue(static_cast<VarType9>(wistd::forward<T9>(varName9)), _TLG_STRINGIZE(varName9)), __VA_ARGS__); }
