...
namespace wil
{
    namespace details
    {
        ...
        inline void RaiseRoOriginateOnWilExceptions(wil::FailureInfo const& failure) WI_NOEXCEPT
        {
...
{
    ::wil::details::g_pfnOriginateCallback = ::wil::details::RaiseRoOriginateOnWilExceptions;
    return 1;
});
