...
namespace wil
{
    ...
    {
    private:
        typedef typename wistd::add_reference<T>::type element_type_reference;
    ...
    //! This function is primarily useful by library or helper code.  It allows code to be written to accept a generic R-Value reference
