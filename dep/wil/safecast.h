...
namespace wil
{
    ...
    template <
        typename NewT,
        typename OldT,
        typename wistd::enable_if_t<details::is_supported_unsafe_cast_no_wchar_v<NewT, OldT>, int> = 0
    >
    ...
    template <
        typename NewT,
        typename OldT,
        typename wistd::enable_if_t<details::is_supported_unsafe_cast_from_wchar_v<NewT, OldT>, int> = 0
    >
    NewT safe_cast_failfast(const OldT var)
    {
        NewT newVar;
    ...
    template <
        typename NewT,
        typename OldT,
        typename wistd::enable_if_t<details::is_supported_unsafe_cast_to_wchar_v<NewT, OldT>, int> = 0
    >
    NewT safe_cast_failfast(const OldT var)
    {
    ...
    template <
        typename NewT,
        typename OldT,
        typename wistd::enable_if_t<details::is_supported_safe_static_cast_v<NewT, OldT>, int> = 0
    >
    NewT safe_cast_failfast(const OldT var)
    {
    ...
    template <
        typename NewT,
        typename OldT,
        typename wistd::enable_if_t<details::is_supported_unsafe_cast_v<NewT, OldT>, int> = 0
    >
