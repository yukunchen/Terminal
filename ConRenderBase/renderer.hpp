...
#include "..\inc\render\IRenderer.hpp"
#include "..\inc\render\IRenderEngine.hpp"
#include "..\inc\render\IRenderData.hpp"
    ...
    namespace Console
    {
        namespace Render
        {
            ...
            private:
                ...
                void _PaintBufferOutputGridLineHelper(_In_ WORD const wAttr, _In_ size_t const cchLine, _In_ COORD const coordTarget);
                ...
                void _UpdateDrawingBrushes(_In_ WORD const wTextAttributes, _In_ bool const fIncludeBackground);
                void _ClearOverlays();
