...
HRESULT Icon::SetIcons(_In_ HICON const hIcon, _In_ HICON const hSmIcon)
{
    ...
    if (SUCCEEDED(hr))
    {
        ...
        if (SUCCEEDED(hr))
        {
            ...
            PostMessageW(g_ciConsoleInformation.hWnd, WM_SETICON, ICON_BIG, (LPARAM)hNewIcon);
            PostMessageW(g_ciConsoleInformation.hWnd, WM_SETICON, ICON_SMALL, (LPARAM)hNewSmIcon);
        }
    }
...
HRESULT Icon::ApplyWindowMessageWorkaround() 
{
    ...
    if (SUCCEEDED(hr))
    {
        ...
        if (SUCCEEDED(hr))
        {
            SendMessageW(g_ciConsoleInformation.hWnd, WM_SETICON, ICON_BIG, (LPARAM)hIcon);
            SendMessageW(g_ciConsoleInformation.hWnd, WM_SETICON, ICON_SMALL, (LPARAM)hSmIcon);
        }
    }
