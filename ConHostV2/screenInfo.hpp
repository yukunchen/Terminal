...
#include "..\ConTermAdapt\adaptDispatch.hpp"
#include "..\ConTermParse\stateMachine.hpp"
...
#define BOTTOM_RIGHT_CORNER 5
    ...
    WORD GetPopupAttributes() const;

    void SetAttributes(_In_ const WORD wAttributes);
    void SetPopupAttributes(_In_ const WORD wPopupAttributes);
...
private:
    ...
    WORD _wAttributes;    // attributes of written text
    WORD _wPopupAttributes;   // attributes of popup text
#ifdef UNIT_TESTING
