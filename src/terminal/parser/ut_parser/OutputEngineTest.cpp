...
public:
    ...
    bool _PrivateModeParamsHelper(_In_ DispatchTypes::PrivateModeParams const param, const bool fEnable)
    {
        ...
        case DispatchTypes::PrivateModeParams::DECCOLM_SetNumberOfColumns:
            fSuccess = SetColumns((unsigned int)(fEnable? DispatchTypes::s_sDECCOLMSetColumns : DispatchTypes::s_sDECCOLMResetColumns));
            break;
...
class StateMachineExternalTest final
{
    ...
    TEST_METHOD(TestSetNumberOfColumns)
    {
        ...
        VERIFY_ARE_EQUAL(pDispatch->_uiWindowWidth, (unsigned int)DispatchTypes::s_sDECCOLMSetColumns);

        pDispatch->ClearState();

        mach.ProcessString(L"\x1b[?3l", 5);
        VERIFY_ARE_EQUAL(pDispatch->_uiWindowWidth, (unsigned int)DispatchTypes::s_sDECCOLMResetColumns);
