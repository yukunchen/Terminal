    ...
    namespace Console
    {
        namespace VirtualTerminal
        {
            ...
            public:
                ...
                void ActionEscDispatch(_In_ wchar_t const wch);
                void ActionCsiDispatch(_In_ wchar_t const wch);
                void ActionClear();
                void ActionIgnore();
                void ActionOscDispatch(_In_ wchar_t const wch);
            ...
            private:
                ...
                bool _IntermediateQuestionMarkDispatch(_In_ wchar_t const wch);
