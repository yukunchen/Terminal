...
{
    bool fRed = IsFlagSet(xtermTableEntry, 0x01);
    bool fGreen = IsFlagSet(xtermTableEntry, 0x02);
    bool fBlue = IsFlagSet(xtermTableEntry, 0x04);
    bool fBright = IsFlagSet(xtermTableEntry, 0x08);
