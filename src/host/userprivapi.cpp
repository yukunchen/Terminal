                                       ...
                                       _In_ DWORD ConsoleInformationLength)
{
    ...
    if (hUser32 != nullptr)
    {
        ...
        static PfnConsoleControl pfn = (PfnConsoleControl)GetProcAddress(hUser32, "ConsoleControl");
...
BOOL UserPrivApi::s_EnterReaderModeHelper(_In_ HWND hwnd)
{
    ...
    if (hUser32 != nullptr)
    {
        ...
        static PfnEnterReaderModeHelper pfn = (PfnEnterReaderModeHelper)GetProcAddress(hUser32, "EnterReaderModeHelper");
                                       ...
                                       _In_ UINT flags)
{
    ...
    if (hUser32 != nullptr)
    {
        ...
        static PfnTranslateMessageEx pfn = (PfnTranslateMessageEx)GetProcAddress(hUser32, "TranslateMessageEx");
