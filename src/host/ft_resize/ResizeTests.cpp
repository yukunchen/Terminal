...
// 1) wcslen(c_wszLoremIpsum) = 26 + 10 + 4 = 40, including 4 DBCS chars
//
// 2) When WriteConsole(c_wszLoremIpsum, ARRAYSIZE(c_wszLoremIpsum)), the trailing NULL char
//    is also written out, thus the char count is now 41:
//    "きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_"
//
// 3) Inside ConsoleScreenBuffer, each DBCS char uses two buffers, thus each c_wszLoremIpsum
//    uses 41 + 4 = 45 buffers
//
...
// For 81 x 21 screen buffer, 3 c_wszLoremIpsum fit into 2 rows of screen buffers
//   1) 3 * c_wszLoremIpsum = 3 * 45 = 135
//   2) 2 * row = 2 * 81 = 162
//   3) there are 162 - 135 = 27 extra trailing blank spaces
//   4) after 20 rows of c_wszLoremIpsum, the last row is left with 81 blank spaces
//
const WCHAR c_wszExpectedPreResize[] =
    L"きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き____________________________"
    L"きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き____________________________"
    L"きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き____________________________"
    L"きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き____________________________"
    L"きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き____________________________"
...
// For 76 x 21 screen buffer, 3 c_wszLoremIpsum fit into 2 rows of screen buffers. However:
//   1) For the first 76-buffer row:
//      - "きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_": buffer count = 45
//      - "きABCDEFGHIJKLMNOPQRSTUVWXYZき": 26 + 4 = 30
//      - there is only one buffer left for the row, thus cannot store "き" from "き0123456789き_".
//        An extra space has to be inserted here
//   2) For the second 76-buffer row:
//      - "き0123456789き_": buffer count = 10 + 4 + 1 = 15
//      - "きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_": 45
//      - there are 76 - (15 + 45) = 16 extra trailing blank spaces
//   3) While 3 c_wszLoremIpsum fit into 2 rows, the second c_wszLoremIpsum now look like
//      "きABCDEFGHIJKLMNOPQRSTUVWXYZき_き0123456789き_". There is an extra space between two "き"
//   4) after 20 rows of c_wszLoremIpsum, the last row is left with 76 blank spaces
//
const WCHAR c_wszExpectedPostResize[] =
    L"きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZき_き0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_________________"
    L"きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZき_き0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_________________"
    L"きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZき_き0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_________________"
    L"きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZき_き0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_________________"
    L"きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZき_き0123456789き_きABCDEFGHIJKLMNOPQRSTUVWXYZきき0123456789き_________________"
