...
#pragma prefast(suppress:__WARNING_NONCONST_LOCAL, "Activity can't be const, since it's set to a random value on startup.")
            TraceLoggingWriteTagged(_activity,
                "Settings",
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetAutoPosition(), "AutoPosition"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetHistoryNoDup(), "HistoryNoDuplicates"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetInsertMode(), "InsertMode"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetLineSelection(), "LineSelection"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetQuickEdit(), "QuickEdit"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetWindowAlpha(), "WindowAlpha"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetWrapText(), "WrapText"),
                TraceLoggingUInt32Array(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetColorTable(), (UINT16)ServiceLocator::LocateGlobals()->getConsoleInformation()->GetColorTableSize(), "ColorTable"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->CP, "CodePageInput"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->OutputCP, "CodePageOutput"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetFontSize().X, "FontSizeX"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetFontSize().Y, "FontSizeY"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetHotKey(), "HotKey"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetScreenBufferSize().X, "ScreenBufferSizeX"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetScreenBufferSize().Y, "ScreenBufferSizeY"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetStartupFlags(), "StartupFlags"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetVirtTermLevel(), "VirtualTerminalLevel"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetWindowSize().X, "WindowSizeX"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetWindowSize().Y, "WindowSizeY"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetWindowOrigin().X, "WindowOriginX"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetWindowOrigin().Y, "WindowOriginY"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetFaceName(), "FontName"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->IsAltF4CloseAllowed(), "AllowAltF4Close"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetCtrlKeyShortcutsDisabled(), "ControlKeyShortcutsDisabled"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetEnableColorSelection(), "EnabledColorSelection"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetExtendedEditKey(), "ExtendedEditKey"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetFilterOnPaste(), "FilterOnPaste"),
                TraceLoggingBool(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetTrimLeadingZeros(), "TrimLeadingZeros"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetLaunchFaceName(), "LaunchFontName"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->NumCommandHistories, "CommandHistoriesNumber"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetCodePage(), "CodePage"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetCursorSize(), "CursorSize"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetFontFamily(), "FontFamily"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetFontWeight(), "FontWeight"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetHistoryBufferSize(), "HistoryBufferSize"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetNumberOfHistoryBuffers(), "HistoryBuffersNumber"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetScrollScale(), "ScrollScale"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetFillAttribute(), "FillAttribute"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetPopupFillAttribute(), "PopupFillAttribute"),
                TraceLoggingValue(ServiceLocator::LocateGlobals()->getConsoleInformation()->GetShowWindow(), "ShowWindow"),
                TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES));
