...
class DimensionsTests
{
    ...
    BEGIN_TEST_METHOD(TestGetLargestConsoleWindowSize)
    END_TEST_METHOD()

    BEGIN_TEST_METHOD(TestGetConsoleScreenBufferInfoAndEx)
    END_TEST_METHOD()
    ...
    BEGIN_TEST_METHOD(TestSetConsoleScreenBufferInfoEx)
    END_TEST_METHOD()
};
...
void DimensionsTests::TestSetConsoleScreenBufferSize()
{
    ...
    RestrictDimensionsHelper(&coordSize, (SHORT)MAXSHORT, (SHORT)MAXSHORT, fAdjustX, fAdjustY);
    ...
    RestrictDimensionsHelper(&coordSize, (SHORT)MINSHORT, (SHORT)MINSHORT, fAdjustX, fAdjustY);
