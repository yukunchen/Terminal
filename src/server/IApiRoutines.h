...
#pragma region L1
    ...
    virtual void GetConsoleOutputModeImpl(_In_ const IConsoleOutputObject& OutContext,
                                          _Out_ ULONG* const pMode) = 0;
    ...
    [[nodiscard]]
    virtual HRESULT SetConsoleOutputModeImpl(_Inout_ IConsoleOutputObject& OutContext,
                                             const ULONG Mode) = 0;
    ...
    [[nodiscard]]
    virtual HRESULT WriteConsoleAImpl(_Inout_ IConsoleOutputObject& OutContext,
    ...
    [[nodiscard]]
    virtual HRESULT WriteConsoleWImpl(_Inout_ IConsoleOutputObject& OutContext,
...
#pragma region L2
    ...
    [[nodiscard]]
    virtual HRESULT FillConsoleOutputAttributeImpl(_Inout_ IConsoleOutputObject& OutContext,
    ...
    [[nodiscard]]
    virtual HRESULT FillConsoleOutputCharacterAImpl(_Inout_ IConsoleOutputObject& OutContext,
    ...
    [[nodiscard]]
    virtual HRESULT FillConsoleOutputCharacterWImpl(_Inout_ IConsoleOutputObject& OutContext,
                                                    const wchar_t Character,
                                                    const DWORD LengthToWrite,
                                                    const COORD StartingCoordinate,
                                                    _Out_ DWORD* const pCellsModified);

    virtual void SetConsoleActiveScreenBufferImpl(_Inout_ IConsoleOutputObject& NewOutContext) = 0;
    ...
    virtual void GetConsoleCursorInfoImpl(_In_ const IConsoleOutputObject& OutContext,
                                          _Out_ ULONG* const pCursorSize,
                                          _Out_ bool* const pIsVisible) = 0;

    [[nodiscard]]
    virtual HRESULT SetConsoleCursorInfoImpl(_Inout_ IConsoleOutputObject& OutContext,
                                             const ULONG CursorSize,
                                             const bool IsVisible) = 0;

    // driver will pare down for non-Ex method
    virtual void GetConsoleScreenBufferInfoExImpl(_In_ const IConsoleOutputObject& OutContext,
                                                  _Out_ CONSOLE_SCREEN_BUFFER_INFOEX* const pScreenBufferInfoEx) = 0;

    [[nodiscard]]
    virtual HRESULT SetConsoleScreenBufferInfoExImpl(_Inout_ IConsoleOutputObject& OutContext,
                                                     const CONSOLE_SCREEN_BUFFER_INFOEX* const pScreenBufferInfoEx) = 0;

    [[nodiscard]]
    virtual HRESULT SetConsoleScreenBufferSizeImpl(_Inout_ IConsoleOutputObject& OutContext,
                                                   const COORD* const pSize) = 0;

    [[nodiscard]]
    virtual HRESULT SetConsoleCursorPositionImpl(_Inout_ IConsoleOutputObject& OutContext,
                                                 const COORD* const pCursorPosition) = 0;

    virtual void GetLargestConsoleWindowSizeImpl(_In_ const IConsoleOutputObject& OutContext,
                                                 _Out_ COORD* const pSize) = 0;

    [[nodiscard]]
    virtual HRESULT ScrollConsoleScreenBufferAImpl(_Inout_ IConsoleOutputObject& OutContext,
    ...
    [[nodiscard]]
    virtual HRESULT ScrollConsoleScreenBufferWImpl(_Inout_ IConsoleOutputObject& OutContext,
                                                   const SMALL_RECT* const pSourceRectangle,
                                                   const COORD* const pTargetOrigin,
                                                   _In_opt_ const SMALL_RECT* const pTargetClipRectangle,
    ...
    [[nodiscard]]
    virtual HRESULT SetConsoleTextAttributeImpl(_Inout_ IConsoleOutputObject& OutContext,
                                                const WORD Attribute) = 0;

    [[nodiscard]]
    virtual HRESULT SetConsoleWindowInfoImpl(_Inout_ IConsoleOutputObject& OutContext,
                                             const bool IsAbsoluteRectangle,
                                             const SMALL_RECT* const pWindowRectangle) = 0;

    [[nodiscard]]
    virtual HRESULT ReadConsoleOutputAttributeImpl(_In_ const IConsoleOutputObject& OutContext,
    ...
    [[nodiscard]]
    virtual HRESULT ReadConsoleOutputCharacterAImpl(_In_ const IConsoleOutputObject& OutContext,
                                                    const COORD* const pSourceOrigin,
    ...
    [[nodiscard]]
    virtual HRESULT ReadConsoleOutputCharacterWImpl(_In_ const IConsoleOutputObject& OutContext,
                                                    const COORD* const pSourceOrigin,
    ...
    [[nodiscard]]
    virtual HRESULT WriteConsoleOutputAImpl(_Inout_ IConsoleOutputObject& OutContext,
    ...
    [[nodiscard]]
    virtual HRESULT WriteConsoleOutputWImpl(_Inout_ IConsoleOutputObject&  OutContext,
                                            _In_reads_(pTextBufferSize->X * pTextBufferSize->Y) const CHAR_INFO* const pTextBuffer,
                                            const COORD* const pTextBufferSize,
                                            const COORD* const pTextBufferSourceOrigin,
                                            const SMALL_RECT* const pTargetRectangle,
    ...
    [[nodiscard]]
    virtual HRESULT WriteConsoleOutputAttributeImpl(_Inout_ IConsoleOutputObject& OutContext,
    ...
    [[nodiscard]]
    virtual HRESULT WriteConsoleOutputCharacterAImpl(_Inout_ IConsoleOutputObject& OutContext,
    ...
    [[nodiscard]]
    virtual HRESULT WriteConsoleOutputCharacterWImpl(_Inout_ IConsoleOutputObject& OutContext,
    ...
    [[nodiscard]]
    virtual HRESULT ReadConsoleOutputA(_In_ const IConsoleOutputObject& OutContext,
    ...
    [[nodiscard]]
    virtual HRESULT ReadConsoleOutputW(_In_ const IConsoleOutputObject& OutContext,
                                       _Out_writes_(pTextBufferSize->X * pTextBufferSize->Y) CHAR_INFO* const pTextBuffer,
                                       const COORD* const pTextBufferSize,
                                       const COORD* const pTextBufferTargetOrigin,
                                       const SMALL_RECT* const pSourceRectangle,
...
#pragma region L3
    ...
    [[nodiscard]]
    virtual HRESULT GetConsoleFontSizeImpl(_In_ const IConsoleOutputObject& OutContext,
                                           const DWORD FontIndex,
                                           _Out_ COORD* const pFontSize) = 0;

    // driver will pare down for non-Ex method
    [[nodiscard]]
    virtual HRESULT GetCurrentConsoleFontExImpl(_In_ const IConsoleOutputObject& OutContext,
                                                const bool IsForMaximumWindowSize,
                                                _Out_ CONSOLE_FONT_INFOEX* const pConsoleFontInfoEx) = 0;

    [[nodiscard]]
    virtual HRESULT SetConsoleDisplayModeImpl(_Inout_ SCREEN_INFORMATION& Context,
                                              const ULONG Flags,
...
#pragma endregion
    ...
    [[nodiscard]]
    virtual HRESULT SetCurrentConsoleFontExImpl(_Inout_ IConsoleOutputObject& OutContext,
                                                const bool IsForMaximumWindowSize,
