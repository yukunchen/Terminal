                                  ...
                                  _Out_ int* pRetVal)
{
    ...
    *pRetVal = 0;
    ...
    try
    {
        ...
        currentColumn = _endpointToColumn(_start);
    }
    CATCH_RETURN();
    ...
    if (unit == TextUnit::TextUnit_Character)
    {
        ...
        try
        {
            newStart = _screenInfoRowToEndpoint(currentScreenInfoRow) + currentColumn;
            newEnd = newStart;
        }
        CATCH_RETURN();
    }
    ...
    {
        // document movement (really just expand to document)
        try
        {
