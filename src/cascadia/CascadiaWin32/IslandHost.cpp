...
IslandHost::IslandHost() noexcept :
...
template <typename T>
IslandHost<T>::~IslandHost()
{
}

void IslandHost::Initialize(DesktopWindowXamlSource source)
{
...
void IslandHost::_InitXamlContent()
{
...
LRESULT IslandHost::MessageHandler(UINT const message, WPARAM const wparam, LPARAM const lparam) noexcept
{
    switch (message) {
    case WM_SETFOCUS:
    {
...
// Return Value:
// - <none>
void IslandHost::_NewScale(UINT dpi)
{
...
// Return Value:
// - <none>
void IslandHost::ApplyCorrection(double scaleFactor)
{
...
void IslandHost::_DoResize(UINT width, UINT height)
{
    _currentWidth = width;
...
void IslandHost::SetRootContent(winrt::Windows::UI::Xaml::UIElement content)
{
