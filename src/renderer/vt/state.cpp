...
HRESULT VtEngine::SetHwnd(_In_ HWND const hwnd)
{
...
HRESULT VtEngine::s_SetWindowLongWHelper(_In_ HWND const hWnd, _In_ int const nIndex, _In_ LONG const dwNewLong)
{
...
// Return Value:
// - S_OK if set successfully or relevant GDI error via HRESULT.
HRESULT VtEngine::_GetProposedFont(_In_ FontInfoDesired const * const pfiFontDesired,
...
// Return Value:
// - X by Y size of the font.
COORD VtEngine::_GetFontSize() const
{
...
bool VtEngine::_IsMinimized() const
{
...
bool VtEngine::_IsFontTrueType() const
{
